...
public class DatabasehandlerNeu extends SQLiteOpenHelper {
    ...
    private static final String MITGLIEDER_PASSWORT = "phone_number";
 
    public DatabasehandlerNeu(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_MITGLIEDER + "("
                + MITGLIEDER_ID + " INTEGER PRIMARY KEY," + MITGLIEDER_EMAIL + " TEXT,"
   ...
   public void addMitglied(Mitglied mitglied) {
        ...
        values.put(MITGLIEDER_PASSWORT, mitglied.getPasswort()); // Contact Phone
   ...
   public Mitglied getMitglied(int id) {
        ...
        Cursor cursor = db.query(TABLE_MITGLIEDER, new String[] { MITGLIEDER_ID,
                MITGLIEDER_EMAIL, MITGLIEDER_PASSWORT }, MITGLIEDER_ID + "=?",
